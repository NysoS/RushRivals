...
public:
	...
	bool FindPathAsync(	UObject* CallingObject, 
	...
	FCPathResult FindPathSynchronous(	FVector Start,
										FVector End,
										uint32 SmoothingPasses = 2,
										int32 UserData = 0,
										float TimeLimit = 0.002f,
										bool RequestRawPath = false,
										bool RequestUserPath = true
	);
	...
	UFUNCTION(BlueprintCallable, Category = "CPath", Meta = (ExpandEnumAsExecs = "Branches"))
		void FindPathSynchronous(	TEnumAsByte<BranchFailSuccessEnum>& Branches,
